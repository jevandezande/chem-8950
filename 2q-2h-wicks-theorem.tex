...
\thmtitle{Wick's theorem (time-independent)} $Q=\gno{Q}+\gno{\ol{Q}}$\vspace{5pt}
\thmproof{
...
$\ip{\vac|Q|\vac}=\gno{\ol{\ol{Q}}}$
\thmproof{
  From Wick's theorem $\ip{\vac|Q|\vac}=\ip{\vac|\gno{Q}|\vac}+\ip{\vac|\gno{\ol{Q}}|\vac}$ and any incompletely contractioned terms have vanishing expectation values.  Therefore, $\ip{\vac|\gno{Q}|\vac}=0$ and $\ip{\vac|\gno{\ol{Q}}|\vac}=\gno{\ol{\ol{Q}}}$.
}
\end{cor}
...
\item
  The expectation value of a string equals the sum of its complete contractions.
\end{enumerate}
...
\begin{dfn}
\thmtitle{Correlation component of $H_e$}
