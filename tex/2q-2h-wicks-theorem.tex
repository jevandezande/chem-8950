...
\thmproof{
  From Wick's theorem $\ip{\vac|Q|\vac}=\ip{\vac|\gno{Q}|\vac}+\ip{\vac|\gno{\ol{Q}}|\vac}$ and any incompletely contracted terms have vanishing expectation values.  Therefore, $\ip{\vac|\gno{Q}|\vac}=0$ and $\ip{\vac|\gno{\ol{Q}}|\vac}=\gno{\ol{\ol{Q}}}$.
}
\end{cor}
