...
As we see in the second equation, diagram notation leads to a vertical arrangement of operators on the page.
In general, a product of excitation diagrams is read from top to bottom, representing left-to-right ordering in the corresponding algebraic expression.
\end{ntt}
