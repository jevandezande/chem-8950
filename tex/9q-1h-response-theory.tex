...
\Cref{appendix:tdpt} shows how to solve this.\\
...
\begin{ex}
\thmtitle{The dipole approximation}
...
\begin{cor}
\thmstatement{
Defining the excitation energy $\w_k\equiv E_k-E_0$, the linear response function can be expressed as follows.
\begin{align*}
  \iip{\tl{W}(t);\tl{V}_\b(t')}
=
-
